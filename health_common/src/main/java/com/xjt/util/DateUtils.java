...
public class DateUtils {
    ...
    public static Date parseString2Date(String dateString) throws Exception {
        ...
        return parseString2Date(dateString, DateUtils.YMD);
    }
    ...
    public static String date2StringYMD(Date date) {
        ...
        return parseDate2String(date, DateUtils.YMD);
    }
    ...
    public static Map<Integer, String> getWeeksOfYear(String year) throws Exception {
        ...
        for (int i = 0; i < weeksCount; i++) {
            ...
            mapWeeks.put(i + 1, date2StringYMD(getFirstDayOfWeek(cal.get(Calendar.YEAR), i)));
        }
        return mapWeeks;
    }
    ...
    public static void main(String[] args) {
        try {
            System.out.println("本周一" + date2StringYMD(getThisWeekMonday()));
            System.out.println("本月一日" + date2StringYMD(getFirstDayOfThisMonth()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
